...
=== Generere og tilby notifikasjoner
Generere og tilby notifikasjoner er den prosessen datatilbyder må gjøre for å tilby hendelseslister med notifikasjoner om endringer i ett eller flere datasett. Hendelselister tilbys på samme måte som beskrevet i eOppslag, men det er spesielle krav til hendelseslister med tanke på søk og nedlasting.
...
=== Innhente og håndtere notifikasjoner
Innhente og håndtere notifikasjoner beskriver konsumering av notafikasjoner. Notifiasjonen leses ved damme mekanismer som i eOppslag, men konsumenten må holde orden i spesielle forhold som kan være rundt hendelseslister.
Konumenten må også være i stand til å vurdere relevansen av hendelsene for seg før videre behandling av norifikasjonene.
...
| Parametere for notifikasjoner som skal hentes fra tilgjengelig hendelsesliste.
...
=== Generere og tilby notifikasjoner
Datatilbyder må etablere en hendelseshåndteringstjeneste som genererer notifikasjoner basert på hendelser eller endringer i ett eller flere datasett. Notifikasjonene tilbys gjennom APIer på samme måte som beskrevet i eOppslag.
