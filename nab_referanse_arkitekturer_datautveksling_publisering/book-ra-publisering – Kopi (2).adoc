...
Det fokuseres her på mønstre som understøtter hendelsesdrevet arkitektur, og det benyttes bevisst et begrepsapparat som gjenspeiler dette. Mønstre for publisering handler derfor her i hovedsak her om publisering av data om hendelser og strømming av slike data. 
...
TIP: I artikkelen  link:https://martinfowler.com/articles/201701-event-driven.html[What do you mean by “Event-Driven”?], redegjør  Martin Fowler kort for noen av de mest aktuelle mønstrene for strømming av hendelser  hendelsesdrevet arkitektur. Han peker også på at dette fremdeles (da i 2017) er et vanskelig område å navigere i, og at det mangler veiledning.

Ambisjonsnivået er ikke her å gi en komplett innføring i alle aspekter. Beskrivelser og utvalg av mønstre som gis  vil utvikles over tid, og vil være behovsdrevet.
...
Henvisninger her er TBD, men se "arkitekturfaglig kunnskapsverksted" om 
...
* https://doc.difi.no/nasjonal-arkitektur/kunnskap_/#_pattern_cqrs_command_query_responsibility_segregation[]
...
Her omtales følgende hovedkategorier:

* _Grunnleggende mønster for publisering_, også kalt _publish-subscribe_. Tilbyder publiserer notifikasjoner om hendelser til en hendelsesliste som ulike konsumenter kan kople seg på og lese fra (abonnere på oppdateringer fra). Det antas her at notifikasjonene inneholder alle relevante data om hendelsene, uten særskilte krav til innholdet.

* _ePublisering_. Dette mønsteret bygger på _grunnleggende mønstre for publisering_, med tillegg av visse detaljer og anbefalinger.
