...
Dette mønsteret er "generisk", der det i begrenset grad gjøres konkrete valg av teknologier og løsninger. 

Mønsteret bygger i hovedsakelig på det mønsteret som i litteraturen tradisjonelt omtales som _publish-subscribe_; se f.eks. link:https://en.wikipedia.org/w/index.php?title=Publish%E2%80%93subscribe_pattern&oldid=950857039[wikipedia om publish-subscribe pattern] for en enkel beskrivelse av dette.

Det tas også inn visse detaljer fra andre arkitekturmønstre.

NOTE: Selv om mønsteret normalt omtales som Publish-Subscribe, understrekes det at abonnement ikke bestandig er nødvendig. Vi kaller det derfor også bare for "publisering".
...
Legg merke til at den publiserte hendelseslisten her betraktes som en del av tilbyders løsning og ansvar. Det samme vil normalt gjelde også om det benyttes en ekstern tjenesteleverandør for publisering.

// erik: bytt ut "hendelsesliste med "publisert hendelsesliste"
...
//der hhv. _grensesnitt for spørring mot hendelsesliste_ og _grensesnitt for levering av notifikasjoner_ 

// Erik: Dette er ikke perfekt, fordi
...
=== Om bruk av eksterne tjenesteleverandører 
