...
Det som er spesifikt for eNotifikasjon er vist med uthevet skrift, dvs. _Inngå avtaler om tilgang og levering av hendelsesstrømmer_, _Generere og tilby notifikasjoner_, samt . Realiseringen av disse kapabilitetene beskrives i prosessmodeller m.v. for eNotifikasjon. 
