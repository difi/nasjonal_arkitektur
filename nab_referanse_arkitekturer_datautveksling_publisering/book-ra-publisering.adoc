...
eNotifikasjon er en referansearkitektur for utveksling av notifikasjoner som er innrettet på å støtte opp under konsepter fra arkitekturmønsteret _Event Sourcing_; karakterisert ved at tilstanden til et _subjekt_ kan bestemmes gjennom en kronologisk sekvens av hendelser, ut fra et gitt øyeblikksbilde.
