...
.Generisk konsept for publisering
image::../nab_referanse_arkitekturer_datautveksling_publisering/media/Generisk konsept for publisering.png[alt=Generisk konsept for publisering image]
