...
image::../nab_referanse_arkitekturer_datautveksling_publisering/media/eNotifikasjon - konsumenters verdistrom.png[alt=eNotifikasjon - konsumenters verdistrom image]
