...
Et viktig prinsipp er å ikke "finne opp hjulet på nytt". Det er dessuten 
// Henrik: Egenskaper? Distribuert, proseseor, uavhengig
// Henrik: Data Mesh... 
// Henrik sammenheng med sammenhengende tjenesterønskelig at et norsk begrepsapparat tilsvarer utbredte engelske begreper.  
