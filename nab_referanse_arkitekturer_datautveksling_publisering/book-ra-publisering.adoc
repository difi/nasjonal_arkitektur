...
.Publisert vs. utvekslet notifikasjon
image::../nab_referanse_arkitekturer_datautveksling_publisering/media/Publisert vs. utvekslet notifikasjon.png[alt=Publisert vs. utvekslet notifikasjon image]
