...
Løs kobling av aktører og komponenter fremmer innovasjon gjennom å lette endringer og få til mer dynamisk etablering av samarbeid mellom aktørene. En ønsker generelt å komme bort fra store monolittiske systemer som ikke er lagt opp til å samspille i en distribuert kontekst. 
...
// Henrik: Egenskaper? Distribuert, proseseor, uavhengig
// Henrik: Data Mesh... 
// Henrik sammenheng med sammenhengende tjenester  
