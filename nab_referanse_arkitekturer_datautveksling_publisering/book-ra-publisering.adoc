...
NOTE: Et sentralt arkitekturmønster som støttes, er best kjent som _Event Sourcing_, blant annet karakterisert ved at tilstanden til et system eller et _subjekt_ kan bestemmes ut fra en logg av hendelser. Se https://doc.difi.no/nasjonal-arkitektur/kunnskap_/#event-sourcing[litteratur om Event Sourcing]
