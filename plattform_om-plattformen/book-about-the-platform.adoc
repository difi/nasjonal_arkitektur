...
NOTE: Nasjonalt Arkitekturverksted fungerer som produksjonsplattform for  *_Torget for digitale fellesløsninger_* (arbeidstittel; se også link:https://www.difi.no/blogg/2019/05/det-er-pa-torget-det-skjer[blogg om Torget, mai 2019].

Plattformen utgjøres i hovedsak av gratis verktøy og åpen kildekode. 

Her gis en kort introduksjon til de viktigste verktøyene i plattformen, samt hvordan disse inngår i aktuelle samarbeidsprosesser.
