...
| Leverandør
| Den som selger eller leverer tjenester, systemer eller lignende. 
Tjenesteleverandører vil normalt representere en behandlingsansvarlig og også ha rollen som databehandler. 
