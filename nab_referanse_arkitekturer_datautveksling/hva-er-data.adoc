...
NOTE: Archimate-standarden skiller mellom konseptuelle data (Business Object), logiske data (Data Object)  og fysiske data  (Artifact). Et slikt skille kan være nyttig.
