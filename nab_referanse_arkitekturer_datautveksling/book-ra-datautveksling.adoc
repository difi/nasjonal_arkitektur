...
Videre behov, som foreløpig ikke dekkes, omfatter blant annet:
...
* Koreografi og orkestrering av meldingsutveksling

* Korrelering av meldinger i prosesser
