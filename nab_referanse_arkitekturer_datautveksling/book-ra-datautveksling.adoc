...
== Generelt
_Referansearkitektur for datautveksling_ gir god praksis for arkitekturer og løsninger innen _temaområdet datautveksling_.
...
3. link:../nab_arkitekturlandskap_segmentarkitektur_datadeling_verdistrømmer/[Felles referansemodeller for datadeling]

4. link:../nab_arkitekturlandskap_segmentarkitektur_datadeling\[Temaområde datadeling].

5. link:../nab_referanse_arkitekturer[Nasjonale referansearkitekturer]
...
c. *Løsningsmønster for eOppslag med bruk av nasjonale fellesløsninger i Norge*
...
// * link:../nab_referanse_arkitekturer_enotifikasjon[Publisering av hendelser (eNotifikasjon)]
