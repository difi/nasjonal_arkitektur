...
4. link:../nab_referanse_arkitekturer_datautveksling/roller-ra-datautveksling.adoc[Roller involvert i datautveksling]

5. link:../nab_arkitekturlandskap_segmentarkitektur_datadeling_verdistrømmer/book_datadeling_verdistrømmer.adoc[Felles referansemodeller for datadeling]
