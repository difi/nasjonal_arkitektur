...
== Generelt
Denne referansearkitekturen er en samling av  arkitekturmønstre og løsningsmønstre som angir beste praksis for arkitekturer og løsninger innen _temaområdet datautveksling_.

Primær målgrupper er virksomhetsarkitekter og  løsningsarkitekter.
...
Her er noen lenker med bakgrunnsinformasjon:
...
6. link:../nab[Nasjonalt arkitekturbibliotek]
