...
* Standardisert støtte for korrelering av meldinger i tverrgående prosesser.



== Leseveiledning

Det skilles mellom konseptuelle arkitekturbeskrivelser og mer løsningsnære beskrivelser som gir merkonkret veiledning, f.eks. ved å angi bruk av nasjonale felleskomponenter.

De generiske og konseptuelle beskrivelsene kommer først, og kan etterfølges av alternative, mer spesifikk arkitektur- eller løsningsmønstre. 
