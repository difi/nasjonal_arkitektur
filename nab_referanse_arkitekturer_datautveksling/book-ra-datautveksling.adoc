...
TIP: Dette er basismønstre som kan brukes og kombineres på flere måter. Arbeid med dette er påbegynt (høst 2019); se under link:..nab_referanse_arkitekturer_tverrgående-tema/avanserte-mønstre[Sammensatte samhandlingsmønstre og avanserte temaer].
