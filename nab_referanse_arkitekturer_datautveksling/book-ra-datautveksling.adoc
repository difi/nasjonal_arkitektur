...
De generiske og konseptuelle beskrivelsene kommer først, og kan etterfølges av alternative, mer spesifikke anvendelser (arkitektur- eller løsningsmønstre). 
...
Se også: 
link:../nab_referanse_arkitekturer_struktur_beskrivelse[Mer om dokumentstruktur]
