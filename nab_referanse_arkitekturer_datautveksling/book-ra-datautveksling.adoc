...
c. link:../nab_referanse_arkitekturer_datautveksling_publisering[Arkitekturnønstre for deling med ukjente parter]

* link:../nab_referanse_arkitekturer_epublisering[ePublisering]


= Mønstre for meldingsutveksling mellom kjente parter
include::../nab_referanse_arkitekturer_datautveksling_forsendelse/book-ra-forsendelse.adoc[]

:leveloffset!:
:leveloffset: +1
= Mønstre for deling med  ukjente parter
