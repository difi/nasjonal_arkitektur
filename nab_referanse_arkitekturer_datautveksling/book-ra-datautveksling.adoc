...
== Generelt
_Referansearkitektur for datautveksling_ er en samling av  arkitekturmønstre og løsningsmønstre som angir beste praksis for arkitekturer og løsninger innen _temaområdet datautveksling_.
