...
Her beskrives realiseringen av de aktuelle kapabilitetene innenfor rammene av synkrone oppslag mot APIer og tilgangsstyring ved bruk av sikkerhetsbilletter.
