...
. *Identifiser samhandlingsmønstre*
...
image:../nab_referanse_arkitekturer_veiledning_valg-av-referansearkitekturer/media/Prosess SBL.png[alt="bad!", width=750]

Prosessen for konkurs og lønnsgaranti kan for eksempel modelleres slik:

image:../nab_referanse_arkitekturer_veiledning_valg-av-referansearkitekturer/media/Basis prosess lønnsgaranti.png[alt="bad!", width=1100]
...
=== Steg 2 - Identifiser samhandlingsmønstre
...
image:../nab_referanse_arkitekturer_veiledning_valg-av-referansearkitekturer/media/Prosess SBL med angivelse av mønster.png[alt="bad!", width=750]

I prosessen for konkurs og lønnsgaranti kan vi identifisere flere ulike samhandlingsmønster:

image:../nab_referanse_arkitekturer_veiledning_valg-av-referansearkitekturer/media/Prosess med mønster lønnsgaranti.png[alt="bad!", width=1100]
...
Når samhandlingsmønstre er identifisert i steg 2, så kan man mappe hvert enkelt samhandlingsmønster mot en  referansearkitektur.

Har man fått til en god enighet om samhandlingsmønstre, så vil ofte prosessen med å mappe mot referansearkitektur være ganske enkel ved å følge oversikten over hvilken referansearkitektur som anbefales for et bestemt samhandlingsmønster.

Mapping til referansearkitektur for lånesøknad vil da se slik ut:

image:../nab_referanse_arkitekturer_veiledning_valg-av-referansearkitekturer/media/Prosess SBL med angivelse av referansearkitektur.png[alt="bad!", width=750]

Mapping til referansearkitektur for  konkurs og lønnsgaranti vil da se slik ut:

image:../nab_referanse_arkitekturer_veiledning_valg-av-referansearkitekturer/media/Samhandling bostyrer og NAV.png[alt="bad!", width=1100]
...
image:../nab_referanse_arkitekturer_veiledning_valg-av-referansearkitekturer/media/Mapping referansearkitektur til løsningsarkitektur.png[alt="missing figure", width=250]
