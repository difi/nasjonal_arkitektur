...
=== Attributter
Her gis en informasjonsmodell med spesifikasjon av attributter og gyldige verdier for ulike konsepter i Archimate, med angivelse av hva som er generisk/felles og hva som er spesielt for visse konsepter.
