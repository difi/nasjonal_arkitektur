...
[.lead]
Basismønstre for datautveksling kan kombineres og brukes på ulike måter. Her beskrives noen typiske slike, sammensatte mønstre - eller _samhandlingsmønstre_.
