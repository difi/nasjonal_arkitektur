...
| Registrere API
| business-process
| Registere API i relevante tjenester, api-katalog, Maskinporten, Kapabilitetsoversikt
...
| business-process
| Registrere hvilke databrukere som skal få tilgang
...
| Registering av delegerte rettigheter
| application-service
...
| Datautveksling
| application-service
| Tjeneste for utveksling av data. Benyttes av avsender og mottaker for transport av meldinger.
