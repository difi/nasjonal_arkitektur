...
Test lenke: <<../nab_arkitekturlandskapr_strategisk-arkitektur_kapabilitetskart.adoc/kapabilitetskart#Deling av data på forespørsel, Deling av data på forespørsel>>
