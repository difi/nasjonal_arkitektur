...
Test lenke: <<../nab_arkitekturlandskapr_strategisk-arkitektur_kapabilitetskart/kapabilitetskart.adoc/#Deling av data på forespørsel, Deling av data på forespørsel>>
...
eOppslag er en referansearkitektur som adresserer en delmengde av kapabilitesområdet link:../nab_arkitekturlandskapr_strategisk-arkitektur_kapabilitetskart/[_Deling av data på forespørsel_], nærmere bestemt synkrone API-kall. Referansearkitekturen dekker både sikrede API-er og API-er som tilbyr åpent tilgjengelige data uten tilgangsbegrensninger. 
Beskrivelsen av referansearkitekturen dekker klargjøring og oppsett, i tillegg til operativ datautveksling mellom tilbyder og konsument. 
