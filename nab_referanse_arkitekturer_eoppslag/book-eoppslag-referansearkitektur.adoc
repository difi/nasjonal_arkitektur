...
== Om _Deling av data på forespørsel_
Temaområdet link:../nab_arkitekturlandskapr_strategisk-arkitektur_kapabilitetskart/[_Deling av data på forespørsel_] finnes separat beskrevet i strukturen under kapabiliteteskart.
