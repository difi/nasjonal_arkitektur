...
<<../nab_arkitekturlandskapr_strategisk-arkitektur_kapabilitetskart.adoc/kapabilitetskart#section-Deling av data på forespørsel,Deling av data på forespørsel>>
