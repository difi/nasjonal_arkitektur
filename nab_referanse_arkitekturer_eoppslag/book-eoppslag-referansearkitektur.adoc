...
Beskrivelse av kapabilitetene som inngår i å klargjøre for deling av data på forespørsel. Dette er prosessene som må til for å registrere APIer, klienter og å sette opp tilganger både fra tilbyder og konsument sin side. 
