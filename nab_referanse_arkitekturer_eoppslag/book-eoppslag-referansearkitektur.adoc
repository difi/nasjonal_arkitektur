...
* _Tilgjengeliggjøre API_ omhandler hvordan man registerer API og setter opp tilganger. 
* _Avgi forespurte data_ omhandler den operative delingen av data.


Tilsvarende er det tre detaljerte kapabiliteter tilknyttet konsument og det å innhente data: 

* _Få tilgang til API_ består av prosesser for oppsett av tilgang.
* _Delegering av rettigheter til databehandler_ må gjøres dersom konsument benytter seg av en databehandler.
* _Slå opp data gjennom API_ er det konsumenten må gjøre hver gang det gjøres et oppslag.
