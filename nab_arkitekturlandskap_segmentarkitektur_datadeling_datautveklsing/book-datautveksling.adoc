...
* Deling av hendelsesdata: Publisering av hendelsesdata, med løs kopling mellom avsendere og mottakere.  

Dette er illustrert i følgende figur.

.Områder innen datautveksling
image::../nab_arkitekturlandskap_segmentarkitektur_datadeling/media/Områder innen datautveksling.png[alt=Områder innen datautveksling image]
