...
//image:../na_felles/media/difilogo.svg[image,width=169,height=66]
...
Se link:../na_modeller/[modellbiblioteket] om arkitekturmodeller.
...
. link:../na_rammeverk/[Rammeverk]
. link:../na_arkitekturlandskap/[Arkitekturlandskap]
. link:../na_løsningslandskap/[Løsningslandskap]
. link:../na_standarder/[Standarder]
. link:../na_kravbibliotek/[Funksjonelle behov (kravbibliotek)]
. link:../na_referanse_/[Referansebibliotek]
. link:../na_organisering/[Organisering og kompetanse]
. link:../na_styring/[Styring og oppfølging]
