...
image:../nab_referanse_modeller_kapabiliteter/media/kapabilitetsområder-nasjonal-arkitektur.png[]
...
image:../nab_referanse_modeller_kapabiliteter\media/kapabilitetsområder-datadeling.png[]
