...
* Elektronisk mottakeradresseregister (link:https://samarbeid.difi.no/felleslosninger/elma[ELMA]): Norsk register over foretak som kan ta i mot dokumenter i standardisert EHF-format.
...
image::../nab_referanse_arkitekturer_emelding/media/SBB_klargjøre.png[alt=Klargjør for eMelding (løsningsmønster) image]

Forklaring til figur:

[cols ="1,3", options="header"]
.Elementer i view for Klargjør for eMelding (løsningsmønster)
|===
...
[cols ="1,3", options="header"]
.Elementer i view for Send eMelding  (løsningsmønster)
|===
...
[cols ="1,3", options="header"]
.Elementer i view for Motta eMelding (løsningsmønster)
|===
