...
==== Innmelding i fellesskap (community)

==== Slå opp adresse og kapabiliteter
image:../nab_referanse_arkitekturer_emelding/media/Slå opp adresse.png[alt="Bilde mangler", width=500]

==== Registrere adresse og kapabiliteter
image:../nab_referanse_arkitekturer_emelding/media/Registrere adresse.png[alt="Bilde mangler", width=600]
