...
[.lead]
eMelding er en referansearkitektur  under området _Deling av data ved forsendelse_, og kan ses på som en "beste praksis" for meldingsutveksling på tvers av virksomheter, sektorer og landegrenser.
...
link:../nab_referanse_arkitekturer_datautveksling_forsendelse[Grunnleggende mønstre og konsepter for _forsendelse_] beskriver "firehjørnersmodellen", der det blant annet redegjøres for
...
Her gjengis en figur sin viser "firehjørnersmodellen":
...
==== Send eMelding
Send eMelding detaljerer prosessen med å sende en melding etter klargjøring for forsendelse. Alle stegene i prosessen vil ikke alltid være nødvendig avhengig av dataene som utveksles og spesifikasjonene for samhandling innen fellesskapet.

.Send eMelding (arkitekturmønster)
image::../nab_referanse_arkitekturer_emelding/media/Send eMelding (arkitekturmønster).png[alt=Send eMelding (arkitekturmønster) image]
...
image::../nab_referanse_arkitekturer_emelding/media/Motta eMelding (arkitekturmønster).png[alt=Motta eMelding (arkitekturmønster) image]
...
== Mulige videre anvendelser
TBD.

== Mer om "firehjørnersmodellen"
=== Konsept (operativt)
