...
Modellen under viser hovedinndelingen i kapabiliteter en avsender og en mottaker må ha for å dele data ved meldingsutveklsing. Beskrivelsene tar utgangspunkt i meldingsutveksling innenfor et fellesskap. Dette er en delmengde av det større området som omhandler Deling av data på forespørsel.
