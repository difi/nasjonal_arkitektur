...
Introduksjon til "firehjørnersmodellen" pluss øvrige ABB-er kommer her!




#Foreløpig figur (her PEPPOL, men erstattes med generisk figur):#

.PEPPOL eDelivery Network overview
image::../kunnskap_losning_eu-peppol\media/PEPPOL eDelivery Network overview.png[]

 
TODO: Gi en sammenlikning mellom en tradisjonell ESB (begrenset  skaleriug) og eMelding (gloal skalering).

TODO: Beskriv muligheten for å opprette flere communities! 
...
Beskrivelsene her viser hvordan den generiske referansearkitekturen for eMelding kan realiseres med #arkitektur- og løsningskomponenter# som inngår i PEPPOL-infrastrukturen.

Arkitekturbyggeklosser med flere mulige leverandører og løsninger;
