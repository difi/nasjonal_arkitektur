...
image:../nab_referanse_arkitekturer_enotifikasjon/media/Kapabiliteter eNotifikasjon.png[alt="Bilde mangler", width=500]
...
* Hendelser = Den faktiske hendelsen  som faktisk er en hendelse.
* Datastrøm = komplettheten rundt en hendelse.
