...
Som vist i figuren, skille det mellom to hovedtyper API-er: 
...
* En hendelse kan representeres ved en eller _notifikasjoner_.
...
* Hver enketl konsument kan lese samme notifikasjon flere ganger.  
...
=== Utdyping av særskilte temaer  

* Konsepttegning og tekst om teamer fra "event sourcing"
* Filtrering
* Abonnememter
* Dataminimering
* ...
