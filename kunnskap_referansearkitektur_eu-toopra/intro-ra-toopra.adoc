...
Andre betegnelser på denne referansearkitekturen er _Generic Federated OOP Architecture_ eller bare   _OOP-arkitekturen_. 

_TOOPRA_ samsvarer med EIF og link:../kunnskap_referansearkitektur_eu-eira[EIRA]. Dette er overordnede, eksisterende rammeverk og referansearktektur.
...
image:../kunnskap_referansearkitektur_eu-toopra/media/toopra.png[]
