...
. link:../na_referanse_arkitekturer_eoppslag_sikkerhet/eOppslag_sikkerhetsmodell_overordnet.adoc[Overordnet innføring i sikkerhetsmekanismer for eOppslag]

. link:../na_referanse_arkitekturer_eoppslag_sikkerhet/20180629-eoppslag-autorisering-og-delegering.adoc[Modell for autorisering og delegering - eOppslag]
