...
Here are a couple of image examples: an //image:./media/smallnew.png[]
example inline image followed by an example block image:./media/

.Tiger block image
//image:./media/tiger.png[Tiger image]
