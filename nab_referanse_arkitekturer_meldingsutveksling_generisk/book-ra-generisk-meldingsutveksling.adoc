...
b. Bilteral avtale, der avtalen registreres hos tiltrodd tredjepart (avtaleforvalter).
...
== Praktiske anvendelser - meldingsforsendelse til kjent mottaker

=== Meldingsforsendelse gjennom eFormidling
