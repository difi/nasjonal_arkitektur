:lang: no
:doctitle: Generisk mønster for meldingsforsendelse til kjent mottaker
:keywords: 
:toclevels: 4
...
== Brukstilfeller
Aktuelle brukstilfeller for __Generisk nønster for meldingsforsendelse til kjent mottaker__:
...
Det forutsettes altså at det finnes en kommunikasjonsinfrastruktur som det kan sendes meldinger over. I sin enkleste form er dette internett. Det kan også finnes krav til bestente formater og protokoller i en mer spesialisert meldingsinfrastruktur. 
...
Selv om avsender kjenner mottaker på forhånd, kan det være aktuelt å slå opp detaljer om mottakers kommunikasjonsløsning i tilknytning til selve forsendelsen. Dette gjøres typisk gjennom run-time oppslagstjenester som er innebygget i infrastrukuren; her vist som en (konseptuell) tjeneste for __Kapabilitets-og adresseoppslag__.   
...
Følgende figur illlustrerer det generelle konseptet.
...
image:../nab_referanse_arkitekturer_meldingsutveksling_generisk/media/kapabiliteter_forsendelse.png[alt="Bilde mangler", width=750]
...
TIP: #_Bør beskrivelsene nedefor endres slik at det tas høyde for både avtalefellesskap og bilaterale avtaler?_#

.Klargjør for eMelding (arkitekturmønster)
image::../nab_referanse_arkitekturer_meldingsutveksling_generisk/media/Klargjør for eMelding (arkitekturmønster).png[alt=Klargjør for eMelding (arkitekturmønster) image]

Forklaring til figur:

[cols ="1,3", options="header"]
.Elementer i view for Klargjør for eMelding (arkitekturmønster)
|===
...
image::../nab_referanse_arkitekturer_meldingsutveksling_generisk/media/Send eMelding (arkitekturmønster).png[alt=Send eMelding (arkitekturmønster) image]

Forklaring til figur:

[cols ="1,3", options="header"]
.Elementer i view for Send eMelding (arkitekturmønster)
|===
...
.Motta eMelding (arkitekturmønster)
image::../nab_referanse_arkitekturer_meldingsutveksling_generisk/media/Motta eMelding (arkitekturmønster).png[alt=Motta eMelding (arkitekturmønster) image]

Forklaring til figur:

[cols ="1,3", options="header"]
.Elementer i view for Motta eMelding (arkitekturmønster)
|===
...
== Praktiske anvendelser av generisk mønster for  meldingsforsendelse til kjent mottaker


=== Meldingsforsendelse gjennom PEPPOL, basert på eMelding

Se under link:../nab_referanse_arkitekturer_emelding[referansearkitekturen eMelding].

=== Meldingsforsendelse gjennom eFormidlings-løsningen

TBD.

=== Meldingsforsendelse i helsesektoren
