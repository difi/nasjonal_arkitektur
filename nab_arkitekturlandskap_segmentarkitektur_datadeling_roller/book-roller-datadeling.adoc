...
Spesialisering av generelle roller ergjort for å gi mer presise,kontekstspesifikke definisjoner. Eksempel: _Avsender_ er en _datatilbyder_ som sender meldinger. 
