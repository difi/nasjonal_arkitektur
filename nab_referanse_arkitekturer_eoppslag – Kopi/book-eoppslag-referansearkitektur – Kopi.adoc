...
Mer informasjon om kapabilitetskart og nedbrytingen av overordnede temaområder og kapabiliteter finnes under link:../nab_arkitekturlandskap[Nasjonalt arkitekturlandskap]. Her finnes _Deling av data på forespørsel_ som et eget område under området _Datautveklsing_. 
...
//erik: ikke bare behov for, si heller bare "som bruker"
//erik: erdet viktig at det er i en egen virksomhetsprosess? VI BØR HA SEPARAT BESKRIVELSE AV hvordan disse referansearkitekturene inngår i samhandlingsprosesser  
...
// erik: dropp "sub-"?
// erik: Evene
// erik: "registrere eget API fellestjenetser"??
...
erik: "evene til å få tilgang" høres rart ut, bare...
...
// erik: må det være eksternt (se også over)?
...
// erik: her kunnejeg tenkjt meg å skrive noe mer... kan være en/mange osv...
...
// erik: "letter" -> "lettere"
// erik: registerere APIi nasjonale fellesløsninger?
// erik:dette forutsetter vel ingenting om konsumenten, dvs. droppp siste setning?
...
////
erik, ny tekst (men lurer litt på siste setning:

_Få tilgang til API_ er det en konsument av data må gjøre for å få tilgang til data gjennom et API. Det omfatter å få kjennskap til aktuelt API, inngå avtale om bruk av data, samt å registrere den tekniske komponenten som skal utføre tjenestekallet. Dersom det dreier seg om tilgang til et _åpent tilgjengelig_ API, behøves ikke de viste prossesstegene for å inngå avtale og registrere klient med tildelt tilgang???????????????????????
////
...
1. Få på plass Eriks "gamle" figurer av overordnede beskrivelser i riktig Archi-bibliotek
2. Fikse symboler og størrelsen på bokser
3. Fikse navnvs. label
4. Publisere Archi-html 
