:lang: no
:doctitle: Overordnet metode og rammeverk
...
Videre detaljer om metodikk, veiledninger, dokumentasjonskonvensjoner og metamodeller finnes under link:../nab_referanse_[referansebibliotek].


== Grunnleggende konsepter og begrepsapparat

=== Generelt 
Her introduseres noen grunnleggende konsepter. Selv om mye av dette vil være kjent stoff for "garvede arkitekter", gis det også presiseringer og vinklinger inn mot det som er spesielt relevant i tilknytning til Nasjonalt arkitekturbbliotek.   
...
image:../nab_overordnet-metode\media\temaområder-og-kapabiliteter.png[]
