...
This is a collection of architecture patterns... 


== Integration Styles
=== Remote Procedure Invocation
Ref. https://dzone.com/articles/introduction-to-integration-patterns
...
=== Shared Database
Ref. https://www.mulesoft.com/resources/esb/top-five-data-integration-patterns
