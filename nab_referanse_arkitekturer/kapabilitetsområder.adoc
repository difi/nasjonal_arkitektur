...
image:../nab_referanse_arkitekturer/media/Referansearkitekturer deling av data.png[alt="Bilde mangler", width=750]
...
=== Oppdatere data
Med oppdatere data menes det å oppdatere en datakilde på tvers av virksomheter eller fra en aktør som ikke er eier eller forvalter av dataene. 
