...
Oversikt over brukerbehov vedlikeholdes i felles kapabilitetskart innen ulike områder. Kapabilitetskartene vil utvikles over tid, etterhvert som en går inn på nye områder. Tilsvarende vil det utvikles oversikter over referansearkitekurer innen hvert område.

Relatert informasjon:

1. Grunnleggende konsepter rundt kapabilitetskart
