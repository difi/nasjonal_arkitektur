...
Oversikt over brukerbehov vedlikeholdes i et samlet kapabilitetskart, ordnet under et sett av kapabilitetsområder. Dette kartet vil utvikles over tid, etterhvert som en går inn på nye områder. Tilsvarende vil det utvikles oversikter over referansearkitekurer innen hvert kapabilitetsområde.
...
== Kapabilitetskart
:leveloffset: +1
include::../nab_referanse_modeller_kapabiliteter/main.adoc[]
:leveloffset: -1
