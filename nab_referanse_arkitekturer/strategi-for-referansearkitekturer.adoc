...
I dokumentasjon av link:../nab_referanse_arkitekturer_samhandlingsmønstre/main.adoc[Samhandlingsmønstre] dokumenteres det hvordan de forskjellige forretningsmessige samhandlingsmønstrene hver og en kan mappes mot en bestemt referansearkitektur. For en referansearkitektur kan man så igjen finne beste tekniske løsningsarkitektur som dokumenterer beste praksis for hvordan man teknisk skal samhandle for å realisere et samhandlingsmønster. Se link:../nab_referanse_arkitekturer_veiledning_valg-av-referansearkitekturer[Metode for valg av referansearkitektur] for beste praksis for å gå fra digital samhandlingsprosess til løsningsarkitektur.
