...
image:../plattform_felles/media/i-arbeid.png[width=75, height=75] [red]#NB! Fiks navn (og objekter) på "områdene", så de stemmer med det foregående. Også vurder flytting til seperat kapittel.#
