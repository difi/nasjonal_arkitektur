...
== Oversikt over overordnede kapabilitetsområder (nivå 1) 
...
image:../plattform_felles/media/i-arbeid.png[width=75, height=75] I arbeid - endringer i denne oversikten må forventes 
