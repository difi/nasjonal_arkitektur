...
ifdef::Erik-kommentarer[] 
****
[white]##Erik-kommentar: Overskriften om "status" er ikke gjenspeilet i teksten - her er det  ##
****
endif::[]
...
Referansearkitekturen er delt inn i flere områder som vist i figurene under. I tillegg vil det være en del overgripende temaer bl.a. tilknyttet informasjonssikkerhet.
