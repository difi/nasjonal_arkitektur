...
NOTE: Difi arbeider i 2019 med å ta fram en helhetlig oversikt over kapabilitetsområder i nasjonal arkitektur. Se link:../adoc[egen omtale av kapabilitetsmodellering].
