...
Følgende figur illustrerer begrepsapparatet rundt referansearkitekturer, slik dette  benyttes i tilknytning til arbeidet ned nasjonal arkitektur. Forklaring til denne figuren:
