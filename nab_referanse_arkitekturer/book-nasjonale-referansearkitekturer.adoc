...
De nasjonale referansearkitekturene bygger på link:../nab_referanse_arkitekturer/grunnleggende-referansearkitekturer.adoc[Grunnleggende referansearkitekturer] fra EU og amdre kilder, men er tilpasset norske aktører og fellesløsninger. Det gis også referanser til andre kilder. Det finnes mye stoff om arkitekturmønstre i litteraturen, men det dette kan være en jungel å finne fram i, med ulik forståelse av samme begreper eller samme navn på ulike mønstre.
...
Lenker til aktuelle referansearkitekturer og mønstre:


1. link:../nab_referanse_arkitekturer_datautveksling/[Referansearkitekturer for datautveksling], herunder

a. link:../nab_referanse_arkitekturer_eoppslag/[eOppslag]

b. link:../nab_referanse_arkitekturer_emelding[eMelding]

c. link:../nab_referanse_arkitekturer_epublisering[ePublisering]
