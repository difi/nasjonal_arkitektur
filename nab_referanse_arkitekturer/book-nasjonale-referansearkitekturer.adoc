...
Hvordan de spesifikke referansearkitekturene er beskrevet forklares her: 
link:../nab_referanse_arkitekturer/struktur_beskrivelser.adoc[Struktur på beskrivelser]
