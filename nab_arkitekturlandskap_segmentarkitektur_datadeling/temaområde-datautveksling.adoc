...
image::../nab_arkitekturlandskap_segmentarkitektur_datadeling/media/Datautveksling - overordnet oversikt over kapabiliteter og temaer.png[alt=Datautveksling - overordnet oversikt over kapabiliteter og temaer image]
