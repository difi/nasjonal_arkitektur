:lang: no
:doctitle: Temaområdet Datautveksling
:keywords: 
:toclevels: 3
include::../plattform_felles/includes/commonincludes.adoc[]


== Kapabilitetskart og tverrgående temaer for datautveksling
...
.Deling av data, fokusområder
image::../nab_arkitekturlandskap_segmentarkitektur_datadeling/media/Deling av data, fokusområder.png[alt=Deling av data, fokusområder image]
