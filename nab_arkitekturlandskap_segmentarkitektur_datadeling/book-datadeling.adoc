...
Som en pragmatisk tilnærming, gis her et forslag til temaområder innen datadeling som ikke ser like nøye på avgrensingen opp mot informasjonsforvaltning forøvrig. Dette er temaer som uansett på dekkes.

Foreløpig oversikt over prioriterte temaområder inen datadeling:
