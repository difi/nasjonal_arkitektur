...
Nedbryting av området _Datadeling og integrasjon_ er vist i figuren nedenfor, her med utgangspunkt i områder som omtales i link:../kunnskap_bok-dmbok2[DMBOK2)].
