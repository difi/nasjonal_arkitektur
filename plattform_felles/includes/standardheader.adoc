...
image:../plattform_felles/media/language.png[width=45]This document was originally written in another language ({difi_orig_language}).
...
image:../plattform_felles/media/language.png[width=45] Dette dokumentet ble opprinnelig skrevet på et annet språk ({difi_orig_language}). Norsk oversettelse er markert som
__{difi_translation_status}__
