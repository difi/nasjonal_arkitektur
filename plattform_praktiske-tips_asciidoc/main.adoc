...
NOTE:  Med en "flat" mappestruktur blir alle relative lenker til samme fil like uansett utgangspunkt (ett hakk opp og ett ned). Dette er en hovedgrunn til valget av flat mappestruktur for Nasjonalt arkitekturverksted.
