...
[.lead]
Archi er et gratis og open-source samarbeidsverktøy som støtter Archimate-standarden for arkitekturdokumentasjon. Difi har utviklet noen scripts som kan lette arbeidet med Archi.        
...
Kun Patreon-medlemmer får tilgang til nedlasting og installasjon av Archi-s Scripting Plugin. For å bli medlem kreves et mindre, månedlig bidrag (størrelsesorden 50 kr. som minimumsbidrag). Se mer om dette under https://www.archimatetool.com/plugins/.

== Installering av aktuelle scripts 

Når du først har installert jArchi, kan du installere scriptene slik:
