...
image:../plattform_felles/media/i-arbeid.png[width=75, height=75] I arbeid... BØR DETTE KAPITLET TAS UT? Kan det  dekkes gjennom omtale av kapabiliteter og kvalitetskrav?

//image:./media/Samhandlingsevne.png[alt="Samhandlingsevne", width=750]

== Generelt om samhandlingsmønstre

Digital samhandling mellom virksomheter kan utføres på et begrenset antall måter sett fra et forretningsståsted. Vi kaller dette samhandlingsmønstre. Samhandlingsmønstre sier ikke noe om hvilken teknologi som skal benyttes, men sier noe om hvilken egenskap samhandlingen skal ha. 

//Det er til nå identifisert seks forskjellige samhandlingsmønstre.


== Aktuelle samhandlingsmønstre
...
****
Forespørsel om informasjon mellom to parter med «ikke umiddelbar» respons 
****
...
== Samhandlingsmønste og kvalitetskrav


.Figur: Samhandlingsmønste og kvalitetskrav
